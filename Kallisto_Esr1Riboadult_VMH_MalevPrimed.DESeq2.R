...
cond1 <- "MaleVMH"
cond2 <- "VMHPrimed"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_Esr1Adult_VMH_MalevPrimed_deopt_batch"
...
samples <- read.table("NewKallistoSheets/AdultEsr1Kallisto_VMH_MalevPrimed.tsv", header=TRUE)
samples
