...
cond1 <- "POAPrimed"
cond2 <- "POAUnprimed"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_Esr1Adult_POA_PrimevUnprimed_deopt_local_"
...
samples <- read.table("NewKallistoSheets/AdultEsr1Kallisto_POA_PrimedvUnprimed.tsv", header=TRUE)
samples
