...
cond1 <- "MeAPrimed"
cond2 <- "MeAUnprimed"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_Esr1Adult_MeA_PrimedvUnprimed_deopt_"
...
samples <- read.table("NewKallistoSheets/AdultEsr1Kallisto_MeA_PrimedvUnprimed.tsv", header=TRUE)
samples
