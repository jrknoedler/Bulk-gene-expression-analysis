...
output <- "DESeq2Scripts/Esr1_TRAP_P15VMH_ProteinRef_batch"
...
sampleTable <- data.frame(condition = factor(c(rep(cond1, 2), rep(cond2, 2))), batch=factor(c(rep("1"),rep("2"),rep("1"),rep("2"))))
