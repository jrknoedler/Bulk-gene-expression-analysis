...
cond1 <- "BNSTPrimed"
cond2 <- "Male BNST"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_Esr1Adult_BNST_PrimedvOutliers_3v2_deopt_local"
...
samples <- read.table("NewKallistoSheets/AdultEsr1Kallisto_BNST_FemalePrimedvOutliers_FULL.tsv", header=TRUE)
samples
