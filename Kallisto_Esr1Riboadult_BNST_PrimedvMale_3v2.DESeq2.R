...
cond1 <- "BNSTPrimed"
cond2 <- "MaleBNST"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_Esr1Adult_BNST_PrimedvMale_deopt"
...
samples <- read.table("NewKallistoSheets/AdultEsr1Kallisto_BNST_FemalePrimedvMale_3v2.tsv", header=TRUE)
samples
