...
cond2 <- "Primed"
cond3 <- "Unprimed"
output <- "DESeq2Scripts/L10_VMH_GLM_3way_dropY_droplow_"
...
samples <- read.table("Kallistosheets/L10_GLM.txt", header=TRUE)
samples
...
sampleTable <- data.frame(condition = factor(c(rep(cond1, 3), rep(cond2, 4), rep(cond3, 3))))
