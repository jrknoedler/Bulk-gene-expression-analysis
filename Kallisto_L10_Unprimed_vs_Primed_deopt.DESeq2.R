...
cond2 <- "Unprimed"
rep2 <- 2
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_L10_PrimedVUnprimed_Deopt_"
...
dir <- "/scratch/users/knoedler/L10_Kallisto_vm17_Deopt_Notiles/"
...
sampleTable <- data.frame(condition = factor(c(rep(cond1, 4), rep(cond2, 3))))
