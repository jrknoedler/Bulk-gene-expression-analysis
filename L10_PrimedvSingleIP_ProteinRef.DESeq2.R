...
# variables
cond1 <- "Primed Female"
cond2 <- "Single House Male"

output <- "DESeq2Scripts/L10_FemalePrimedvSinglehousedmale"
...
samples <- read.table("Kallistosheets_cp/L10_VMH_IP_PrimedvSingle.txt", header=TRUE)
samples
