#!/usr/bin/env Rscript
# variables
cond1 <- "P15FemalePOAInput"
cond2 <- "P15MalePOAInput"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_P15_POAInput_local"
...
samples <- read.table("NewKallistoSheets/P15POAInput.txt", header=TRUE)
samples
