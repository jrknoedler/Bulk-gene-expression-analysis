...
cond2 <- "POAInput"
rep2 <- 4
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_P15POA_InputvIP"
...
samples <- read.table("NewKallistoSheets/P15POAKallistoSheets.txt", header=TRUE)
samples
...
heatmap.2(as.matrix(sampleDists), key=FALSE, symm=TRUE, trace="none", margin=c(15, 15), main=paste0(cond1, " vs ", cond2, " Matrix"))
garbage <- dev.off() # Save to file
