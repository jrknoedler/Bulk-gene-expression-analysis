...
output <- "All_RNASeq_Analyses/DESeq2/AllAdultEsr1_VMH_FULL_fixed_allgenes"
...
samples <- read.table("NewKallistoSheets/AdultEsr1Kallisto_VMH_FULLfixed.tsv", header=TRUE)
samples
...
sampleTable <- data.frame(condition = factor(c(rep(cond1, 3), rep(cond2, 3), rep(cond3, 2))))
