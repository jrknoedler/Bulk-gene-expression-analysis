...
cond4 <- "UnprimedIP"
cond5 <- "MaleIP"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_L10_all_deopt_notile_IP3"
...
samples <- read.table("NewKallistoSheets/AllL10VMHAdult_IP3.txt", header=TRUE)
samples
...
sampleTable <- data.frame(condition = factor(c(rep(cond3, 3), rep(cond4, 3), rep(cond5, 3))))
