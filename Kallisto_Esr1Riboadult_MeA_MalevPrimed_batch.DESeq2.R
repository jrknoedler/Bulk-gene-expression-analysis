...
cond1 <- "MaleMeA"
cond2 <- "MeAPrimed"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_Esr1Adult_MeA_MalevPrimed_deopt_batch"
...
samples <- read.table("NewKallistoSheets/AdultEsr1Kallisto_MeA_MalevPrimed.tsv", header=TRUE)
samples
