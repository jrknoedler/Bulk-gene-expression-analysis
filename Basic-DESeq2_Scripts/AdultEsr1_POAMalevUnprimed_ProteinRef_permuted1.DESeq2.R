...
output <- "DESeq2Scripts/Esr1Adult_POA_ProteinRef_MalevUnprimed_permuted1"
...
samples <- read.table("Kallistosheets_cp/AdultEsr1Kallisto_POA_MalevUnprimed_permuted1.tsv", header=TRUE)
samples
