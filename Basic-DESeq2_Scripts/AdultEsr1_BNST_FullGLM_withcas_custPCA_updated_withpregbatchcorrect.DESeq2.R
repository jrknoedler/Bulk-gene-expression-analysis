...
output <- "DESeq2Scripts/Esr1Adult_BNST_GLM_4way_dropY_droplow_dropmt_newCas_withpreg_PCAtest"
...
samples <- read.table("Kallistosheets/AdultEsr1Kallisto_BNST_FULL_updatedcas_withpreg.tsv", header=TRUE)
samples
...
sampleTable <- data.frame(condition = factor(c(rep(cond1, 3), rep(cond2, 3), rep(cond3, 3), rep(cond4, 3), rep(cond5,3))), batch=factor(c(rep("1"),rep("1"),rep("2"),rep("1"),rep("1"),rep("2"),rep("1"),rep("1"),rep("2"), rep("3",6))))
