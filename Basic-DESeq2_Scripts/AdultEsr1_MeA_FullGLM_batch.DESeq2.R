...
output <- "DESeq2Scripts/Esr1Adult_MeA_GLM_3wayredo_dropY_droplow_Heatmap_dropmt_batchinvert"
...
samples <- read.table("Kallistosheets/AdultEsr1Kallisto_MeA_FULL.tsv", header=TRUE)
samples
