...
output <- "DESeq2Scripts/Esr1Adult_VMH_GLM_3way_dropY_droplow_dropmt_newest_batch2"
...
samples <- read.table("Kallistosheets/AdultEsr1Kallisto_VMH_FULLnocas.tsv", header=TRUE)
samples
