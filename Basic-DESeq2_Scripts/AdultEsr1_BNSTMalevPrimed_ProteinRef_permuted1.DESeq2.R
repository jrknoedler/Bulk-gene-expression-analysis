...
output <- "DESeq2Scripts/Esr1Adult_BNSTMalevPrimed_ProteinReftest_permuted"
...
samples <- read.table("Kallistosheets_cp/AdultEsr1Kallisto_BNST_MalevPrimedPemuted.tsv", header=TRUE)
samples
