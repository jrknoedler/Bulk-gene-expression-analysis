...
output <- "DESeq2Scripts/AdultEsr1_BNST_MalevCastrateNew_134_Deopt_local"
...
samples <- read.table("Kallistosheets/AdultEsr1Kallisto_BNST_MalevCas134.tsv", header=TRUE)
samples
