...
cond3 <- "Unprimed"
cond4 <- "CastrateMale"
output <- "DESeq2Scripts/Esr1Adult_BNST_GLM_4way_redo_batch"
...
sampleTable <- data.frame(condition = factor(c(rep(cond1, 3), rep(cond2, 3), rep(cond3, 3), rep(cond4, 2))), batch = factor(c(rep("1"), rep("1"), rep("1"), rep("1"), rep("1"), rep("1"), rep("2"), rep("2"), rep("1"), rep("1"), rep("1"))))
