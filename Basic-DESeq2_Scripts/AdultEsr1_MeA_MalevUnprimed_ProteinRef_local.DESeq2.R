...
output <- "DESeq2Scripts/Esr1Adult_MeA_ProteinReftest_MalevUnprimed_local"
...
samples <- read.table("Kallistosheets_cp/AdultEsr1Kallisto_MeA_MalevUnprimed.tsv", header=TRUE)
samples
