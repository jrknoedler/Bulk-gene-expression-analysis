...
output <- "DESeq2Scripts/Esr1Adult_POAvRest_"
...
samples <- read.table("Kallistosheets_cp/AllAdultEsr1.tsv", header=TRUE)
samples
...
sampleTable <- data.frame(condition = factor(c(rep(cond1, 11), rep(cond2, 33))))
