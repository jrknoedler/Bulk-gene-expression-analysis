...
output <- "DESeq2Scripts/Esr1Adult_MeA_ProteinReftest_PrimevUnprimed"
...
samples <- read.table("Kallistosheets_cp/AdultEsr1Kallisto_MeA_PrimedvUnprimed.tsv", header=TRUE)
samples
