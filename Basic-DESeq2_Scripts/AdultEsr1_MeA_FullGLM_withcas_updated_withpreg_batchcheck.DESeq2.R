...
output <- "DESeq2Scripts/Esr1Adult_MeA_GLM_4way_dropY_droplow_dropmt_updatedcastratewithpreg_"
...
samples <- read.table("Kallistosheets/AdultEsr1Kallisto_MeA_FULLcaswithpreg.tsv", header=TRUE)
samples
