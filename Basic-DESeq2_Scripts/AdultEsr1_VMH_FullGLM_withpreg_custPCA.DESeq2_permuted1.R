...
cond3 <- "Diestrus"
cond4 <- "Pregnant"
output <- "DESeq2Scripts/Esr1Adult_VMH_GLM_Preg4way_droplowdropYdropmt_GLMdegpca_permuted1"
...
samples <- read.table("Kallistosheets/AdultEsr1Kallisto_VMH_FULLpreg_permuted1.tsv", header=TRUE)
samples
...
#sampleTable <- sampleTable[ychromgenes,]
