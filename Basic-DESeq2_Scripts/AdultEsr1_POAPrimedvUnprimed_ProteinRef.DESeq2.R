...
output <- "DESeq2Scripts/Esr1Adult_POA_ProteinReftest_2v3_local"
...
samples <- read.table("Kallistosheets_cp/AdultEsr1Kallisto_POA_PrimedvUnprimed.tsv", header=TRUE)
samples
...
sampleTable <- data.frame(condition = factor(c(rep(cond1, 2), rep(cond2, 3))))
