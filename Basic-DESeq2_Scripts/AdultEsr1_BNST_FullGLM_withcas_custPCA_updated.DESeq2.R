...
cond3 <- "Unprimed"
cond4 <- "CastrateMale"
output <- "DESeq2Scripts/Esr1Adult_BNST_GLM_4way_dropY_droplow_dropmt_newCas_corrected"
...
samples <- read.table("Kallistosheets/AdultEsr1Kallisto_BNST_FULL_updatedcas.tsv", header=TRUE)
samples
...
names(resUnprimedvCastrate)[1] <- "Gene"
## Write resuls
