...
cond15 <- "CastratePOA"
cond16 <- "CastrateVMH"
output <- "DESeq2Scripts/Esr1Adult_FULL_GLM_withcast_adjust"
...
sampleTable <- data.frame(condition = factor(c(rep(cond1, 3), rep(cond2, 3), rep(cond3, 3), rep(cond4, 3), rep(cond5, 3), rep(cond6, 3), rep(cond7, 3), rep(cond8, 3), rep(cond9, 3), rep(cond10, 3), rep(cond11, 3), rep(cond12, 3), rep(cond13, 3), rep(cond14, 3), rep(cond15, 3), rep(cond16, 3))), batch= factor(c(rep("1"), rep("1"),rep("2"),rep("1"),rep("1"),rep("2"),rep("3"),rep("1"),rep("2"),rep("1"),rep("1"),rep("2"),rep("1"),rep("1"),rep("2"),rep("1"),rep("1"),rep("2"),rep("1"),rep("1"),rep("2"),rep("1"),rep("1"),rep("2"),rep("1"),rep("1"),rep("2"),rep("1"),rep("1"),rep("2"),rep("1"),rep("1"),rep("2"),rep("1"),rep("1"),rep("2"), rep("1"),rep("1"),rep("4"),rep("1"),rep("1"),rep("4"),rep("1"),rep("1"),rep("4"),rep("1"),rep("1"),rep("4"))))
