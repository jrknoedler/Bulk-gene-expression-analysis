...
output <- "DESeq2Scripts/Esr1Adult_MeA_GLM_4way_dropY_droplow_dropmt_updatedcastrate"
...
samples <- read.table("Kallistosheets/AdultEsr1Kallisto_MeA_FULLupdatedcas.tsv", header=TRUE)
samples
