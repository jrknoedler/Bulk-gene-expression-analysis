...
output <- "DESeq2Scripts/Esr1Adult_MeA_GLM_3wayredo_dropY_droplow_Heatmap_dropmt_batchagain"
...
samples <- read.table("Kallistosheets/AdultEsr1Kallisto_MeA_FULLcas.tsv", header=TRUE)
samples
