...
cond3 <- "Unprimed"
cond4 <- "Pregnant"
output <- "DESeq2Scripts/Esr1Adult_BNST_GLM_Preg4way_droplowdropYdropmt_GLM_permuted3"
...
samples <- read.table("Kallistosheets/AdultEsr1Kallisto_BNST_FULLpreg_permuted3.tsv", header=TRUE)
samples
