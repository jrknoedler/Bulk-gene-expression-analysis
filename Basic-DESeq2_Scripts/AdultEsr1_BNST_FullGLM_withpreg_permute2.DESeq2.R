...
cond3 <- "Unprimed"
cond4 <- "Pregnant"
output <- "DESeq2Scripts/Esr1Adult_BNST_GLM_Preg4way_droplowdropYdropmt_GLM_permuted2"
...
samples <- read.table("Kallistosheets/AdultEsr1Kallisto_BNST_FULLpreg_permuted2.tsv", header=TRUE)
samples
