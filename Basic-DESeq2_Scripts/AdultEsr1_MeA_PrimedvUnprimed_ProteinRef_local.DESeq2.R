...
output <- "DESeq2Scripts/Esr1Adult_MeA_ProteinReftest_PrimevUnprimed_local_permuted1"
...
samples <- read.table("Kallistosheets_cp/AdultEsr1Kallisto_MeA_PrimedvUnprimed_permuted1.tsv", header=TRUE)
samples
