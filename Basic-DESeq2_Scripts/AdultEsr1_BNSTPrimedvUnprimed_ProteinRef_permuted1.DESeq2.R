...
output <- "DESeq2Scripts/Esr1Adult_BNSTPrimedvUnprimed_ProteinReftest_permuted"
...
samples <- read.table("Kallistosheets_cp/AdultEsr1Kallisto_BNSTPrimedvUnprimed_permutation1.tsv", header=TRUE)
samples
