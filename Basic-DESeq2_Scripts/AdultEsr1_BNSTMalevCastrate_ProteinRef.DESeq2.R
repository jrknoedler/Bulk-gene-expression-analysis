#!/usr/bin/env Rscript
# variables
cond1 <- "IntactMaleBNST"
cond2 <- "CastrateMaleBNST"

output <- "DESeq2Scripts/Esr1Adult_BNSTMalevCastrate_nooutlier_local"
...
samples <- read.table("Kallistosheets_cp/AdultEsr1Kallisto_BNST_MalevCastrate_FINAL_nooutlier.tsv", header=TRUE)
samples
