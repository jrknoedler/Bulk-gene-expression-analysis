...
cond1 <- "PrimedIP"
cond2 <- "UnprimedIP"
output <- "AdultRiboEsr1NoDedupOut2/DESeq2/Kallisto_L10_FemaleIP_minus2"
...
dir <- "/scratch/users/knoedler/L10Kallisto_vM17/"
samples <- read.table("AdultKallistoDataSheets/L10FemaleIPVMHAdult_minus2.txt", header=TRUE)
samples
