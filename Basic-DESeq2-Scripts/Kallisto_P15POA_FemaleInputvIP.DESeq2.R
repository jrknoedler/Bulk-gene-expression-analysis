...
cond1 <- "FemalePOAIP"
rep1 <- 2
cond2 <- "FemalePOAInput"
rep2 <- 2
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_P15_Female_POA_InputvIP_parametric"
...
samples <- read.table("NewKallistoSheets/P15POA_Female_KallistoSheets.txt", header=TRUE)
samples
