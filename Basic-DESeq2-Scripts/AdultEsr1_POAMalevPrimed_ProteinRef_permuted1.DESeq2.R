...
output <- "DESeq2Scripts/Esr1Adult_POA_ProteinRef_MalevPrimed_local_permuted3"
...
samples <- read.table("Kallistosheets_cp/AdultEsr1Kallisto_POA_newMalevPrimed_permutation3.tsv", header=TRUE)
samples
