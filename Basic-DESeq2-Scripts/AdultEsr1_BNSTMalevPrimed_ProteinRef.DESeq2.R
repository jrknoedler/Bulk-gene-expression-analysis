...
output <- "DESeq2Scripts/Esr1Adult_BNSTMalevPrimed_Latest_3v3_"
...
samples <- read.table("Kallistosheets_cp/AdultEsr1Kallisto_BNST_FemalePrimedvMale_FINAL.tsv", header=TRUE)
samples
