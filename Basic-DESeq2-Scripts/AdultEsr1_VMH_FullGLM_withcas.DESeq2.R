...
cond3 <- "Unprimed"
cond4 <- "CastrateMale"
output <- "DESeq2Scripts/Esr1Adult_VMH_GLM_4way_dropY_droplow_dropmt_newest_heatmapredo"
...
samples <- read.table("Kallistosheets/AdultEsr1Kallisto_VMH_FULL.tsv", header=TRUE)
samples
