...
cond7 <- "PrimedVMH"
cond8 <- "UnprimedVMH"
output <- "DESeq2Scripts/Esr1Adult_PrimedvUnprimed_exploratory_estrous"
...
sampleTable <- data.frame(condition = factor(c(rep(cond1, 3), rep(cond2, 3), rep(cond3, 3), rep(cond4, 3), rep(cond5, 3), rep(cond6, 3), rep(cond7, 3), rep(cond8, 3))), estrous= factor(c(rep("1"), rep("1"),rep("1"),rep("1"),rep("1"),rep("1"),rep("1"),rep("1"),rep("1"),rep("1"),rep("1"),rep("1"),rep("2"),rep("2"),rep("2"),rep("2"),rep("2"),rep("2"),rep("2"),rep("2"),rep("2"),rep("2"),rep("2"),rep("2"))))
rownames(sampleTable) <- colnames(txi.kallisto$counts)


# Run DESeq2 to get the result for differential-expression
dds=DESeqDataSetFromTximport(txi.kallisto, sampleTable, design =~estrous+condition)
