...
cond1 <- "P15_Female"
cond2 <- "P15_Male"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_P15_POAIP_MalevFemale_parametric"
...
samples <- read.table("NewKallistoSheets/AllP15POAIPEsr1Kallisto.txt", header=TRUE)
samples
