...
cond3 <- "Unprimed"
cond4 <- "CastrateMale"
output <- "DESeq2Scripts/Esr1Adult_BNST_GLM_4way_dropY_droplow_dropmt_newCas_batchtest"
...
samples <- read.table("Kallistosheets/AdultEsr1Kallisto_BNST_FULL_updatedcas_batchtest.tsv", header=TRUE)
samples
