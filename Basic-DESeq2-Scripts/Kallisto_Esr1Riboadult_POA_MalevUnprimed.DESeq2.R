...
cond1 <- "MalePOA"
cond2 <- "POAUnprimed"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_Esr1Adult_POA_MalevUnprimed_deopt_"
...
samples <- read.table("NewKallistoSheets/AdultEsr1Kallisto_POA_MalevUnprimed.tsv", header=TRUE)
samples
