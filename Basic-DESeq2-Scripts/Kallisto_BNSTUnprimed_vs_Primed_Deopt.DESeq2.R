...
cond2 <- "BNSTPrimed"
rep2 <- 2
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_BNSTUnprimedVPrimed_Deopt_"
...
samples <- read.table("AdultKallistoDataSheets/AdultKallistoBNST_Deopt_UnprimedvPrimed.tsv", header=TRUE)
samples
