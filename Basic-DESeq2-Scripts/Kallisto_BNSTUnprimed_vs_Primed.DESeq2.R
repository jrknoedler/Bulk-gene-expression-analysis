...
cond2 <- "BNSTUnprimed"
rep2 <- 2
output <- "AdultRiboEsr1NoDedupOut2/DESeq2/Kallisto_BNSTUnprimedVPrimed_"
...
samples <- read.table("AdultKallistoDataSheets/AdultKallistoBNST_Female.tsv", header=TRUE)
samples
