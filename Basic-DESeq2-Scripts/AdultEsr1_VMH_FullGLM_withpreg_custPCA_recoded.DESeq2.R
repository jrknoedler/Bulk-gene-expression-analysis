...
cond2 <- "Virgin"
cond3 <- "Pregnant"
output <- "DESeq2Scripts/Esr1Adult_VMH_GLM_Preg4way_droplowdropYdropmt_GLMdegpca_recoded"
...
dir <- "/scratch/users/knoedler/Kallisto/Kallisto_ProteinRef"
samples <- read.table("Joe_Sherlock_Backup_17/Joe_Sherlock_Backup/Data_TextFiles/Kallistosheets/AdultEsr1Kallisto_VMH_FULLpreg.tsv", header=TRUE)
samples
