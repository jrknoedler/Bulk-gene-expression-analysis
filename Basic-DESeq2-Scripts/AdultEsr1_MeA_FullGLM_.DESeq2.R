...
cond2 <- "PrimedBNST"
cond3 <- "UnprimedBNST"
output <- "DESeq2Scripts/Esr1Adult_MeA_GLM_local"
...
samples <- read.table("Kallistosheets_cp/AdultEsr1Kallisto_MeA_FULL.tsv", header=TRUE)
samples
...
ddsparam <- estimateDispersions(dds1,fitType="parametric")
