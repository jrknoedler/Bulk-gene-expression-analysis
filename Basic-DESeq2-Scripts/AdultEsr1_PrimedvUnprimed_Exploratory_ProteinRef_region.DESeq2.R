...
cond7 <- "PrimedVMH"
cond8 <- "UnprimedVMH"
output <- "DESeq2Scripts/Esr1Adult_PrimedvUnprimed_exploratory_batch_region"
...
samples <- read.table("Kallistosheets_cp/PrimedvUnprimed_all.tsv", header=TRUE)
samples
...
sampleTable <- data.frame(condition = factor(c(rep(cond1, 3), rep(cond2, 3), rep(cond3, 3), rep(cond4, 3), rep(cond5, 3), rep(cond6, 3), rep(cond7, 3), rep(cond8, 3))), batch= factor(c(rep("1"), rep("1"),rep("2"),rep("1"),rep("1"),rep("2"),rep("1"),rep("1"),rep("2"),rep("1"),rep("1"),rep("2"),rep("1"),rep("1"),rep("2"),rep("1"),rep("1"),rep("2"),rep("1"),rep("1"),rep("2"),rep("1"),rep("1"),rep("2"))), region = factor(c(rep("BNST"),rep("BNST"),rep("BNST"),rep("BNST"),rep("BNST"),rep("BNST"),rep("MeA"),rep("MeA"),rep("MeA"),rep("MeA"),rep("MeA"),rep("MeA"),rep("POA"),rep("POA"),rep("POA"),rep("POA"),rep("POA"),rep("POA"),rep("VMH"),rep("VMH"),rep("VMH"),rep("VMH"),rep("VMH"),rep("VMH"))))
rownames(sampleTable) <- colnames(txi.kallisto$counts)


# Run DESeq2 to get the result for differential-expression
dds=DESeqDataSetFromTximport(txi.kallisto, sampleTable, design =~region+batch+condition)
