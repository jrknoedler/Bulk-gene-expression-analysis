...
cond15 <- "CastratePOA"
cond16 <- "CastrateVMH"
output <- "DESeq2Scripts/Esr1Adult_FULL_GLM_withcast_original_groupfirst"
...
resBNST1 <- results(dds, contrast=list("regionBNST.groupPrimed","regionBNST.groupIntactMale"))
...
resBNST2 <- results(dds, contrast=list("regionBNST.groupIntactMale","regionBNST.groupUnprimed"))
...
resBNST3 <- results(dds, contrast=list("regionBNST.groupPrimed","regionBNST.groupUnprimed"))
...
resMeA1 <- results(dds, contrast=list("regionMeA.groupPrimed","regionMeA.groupIntactMale"))
...
resMeA2 <- results(dds, contrast=list("regionMeA.groupUnprimed","regionMeA.groupIntactMale"))
...
resMeA3 <- results(dds, contrast=list("regionMeA.groupPrimed","regionMeA.groupUnprimed"))
...
resPOA1 <- results(dds, contrast=list("regionPOA.groupPrimed","regionPOA.groupIntactMale"))
...
resPOA2 <- results(dds, contrast=list("regionPOA.groupUnprimed","regionPOA.groupIntactMale"))
...
resPOA3 <- results(dds, contrast=list("regionPOA.groupPrimed","regionPOA.groupUnprimed"))
...
resVMH1 <- results(dds, contrast=list("regionVMH.groupPrimed","regionVMH.groupIntactMale"))
...
resVMH2 <- results(dds, contrast=list("regionVMH.groupUnprimed","regionVMH.groupIntactMale"))
...
resVMH3 <- results(dds, contrast=list("regionVMH.groupPrimed","regionVMH.groupUnprimed"))
...
resBNST4 <- results(dds, contrast=list("regionBNST.groupIntactMale","regionBNST.groupCastrateMale"))
...
resMeA4 <- results(dds, contrast=list("regionMeA.groupIntactMale","regionMeA.groupCastrateMale"))
...
resPOA4 <- results(dds, contrast=list("regionPOA.groupIntactMale","regionPOA.groupCastrateMale"))
...
resVMH4 <- results(dds, contrast=list("regionVMH.groupIntactMale","regionVMH.groupCastrateMale"))
