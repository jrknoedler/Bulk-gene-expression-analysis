...
cond3 <- "Unprimed"
cond4 <- "Pregnant"
output <- "DESeq2Scripts/Esr1Adult_POA_GLM_Preg4way_droplowdropYdropmt_GLM_updated"
...
samples <- read.table("Kallistosheets/AdultEsr1Kallisto_POAFULLpreg_updated.tsv", header=TRUE)
samples
