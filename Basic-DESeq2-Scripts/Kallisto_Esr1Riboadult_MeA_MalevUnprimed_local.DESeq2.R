...
cond1 <- "MaleMeA"
cond2 <- "MeAUnprimed"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_Esr1Adult_MeA_MalevUnprimed_deopt_local"
...
samples <- read.table("NewKallistoSheets/AdultEsr1Kallisto_MeA_MalevUnprimed.tsv", header=TRUE)
samples
