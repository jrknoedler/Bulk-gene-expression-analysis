...
output <- "DESeq2Scripts/Esr1Adult_VMH_ProteinRef_MalevCastrate_3v2"
...
samples <- read.table("Kallistosheets_cp/AdultEsr1Kallisto_VMH_MalevCastrate_2v3.tsv", header=TRUE)
samples
