...
output <- "DESeq2Scripts/Esr1Adult_MeA_ProteinReftest_PrimevUnprimed_permuted"
...
samples <- read.table("Kallistosheets_cp/AdultEsr1Kallisto_MeA_MalevPrimed_permuted1.tsv", header=TRUE)
samples
