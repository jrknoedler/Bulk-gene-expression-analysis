...
output <- "DESeq2Scripts/Esr1Adult_VMH_GLM_4way_dropY_droplow_dropmt_newCas_withpreg_PCAtest"
...
samples <- read.table("Kallistosheets/AdultEsr1Kallisto_VMH_FULL_updatedcas_withPreg.tsv", header=TRUE)
samples
...
sampleTable <- data.frame(condition = factor(c(rep(cond1, 3), rep(cond2, 3), rep(cond3, 3), rep(cond4, 3), rep(cond5,3))))
