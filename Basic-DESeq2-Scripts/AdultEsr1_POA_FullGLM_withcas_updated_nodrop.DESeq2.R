...
cond3 <- "Unprimed"
cond4 <- "CastrateMale"
output <- "DESeq2Scripts/Esr1Adult_POA_GLM_4way_dropY_droplow_dropmt_updatedcastrate_nodrop"
...
samples <- read.table("Kallistosheets/AdultEsr1Kallisto_POAFULLupdatedcas.tsv", header=TRUE)
samples
