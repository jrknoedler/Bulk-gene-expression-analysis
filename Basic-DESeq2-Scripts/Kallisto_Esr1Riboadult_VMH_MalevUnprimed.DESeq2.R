...
cond1 <- "MaleVMH"
cond2 <- "VMHUnprimed"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_Esr1Adult_VMH_MalevUnprimed_deopt_batch"
...
samples <- read.table("NewKallistoSheets/AdultEsr1Kallisto_VMH_UnprimedvMale.tsv", header=TRUE)
samples
