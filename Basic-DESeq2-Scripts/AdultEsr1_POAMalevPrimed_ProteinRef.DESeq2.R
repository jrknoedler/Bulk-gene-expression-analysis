...
output <- "DESeq2Scripts/Esr1Adult_POA_ProteinRef_MalevPrimed_Newest_3v2_local"
...
samples <- read.table("Kallistosheets_cp/AdultEsr1Kallisto_POA_newMalevPrimed.tsv", header=TRUE)
samples
