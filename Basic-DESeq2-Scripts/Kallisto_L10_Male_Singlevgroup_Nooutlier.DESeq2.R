...
cond1 <- "SingleHoused"
cond2 <- "GroupHoused"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_L10_Male_SinglevGroup_3v3"
...
samples <- read.table("NewKallistoSheets/L10_Male_SinglevGroup_no_outlier.txt", header=TRUE)
samples
