...
cond2 <- "P15MalePOA"
rep2 <- 2
output <- "AdultRiboEsr1NoDedupOut2/DESeq2/Kallisto_P15POAIP_local_"
...
dir <- "/scratch/users/knoedler/P15Kallisto_vM17/"
samples <- read.table("AdultKallistoDataSheets/P15POAKallisto.txt", header=TRUE)
samples
