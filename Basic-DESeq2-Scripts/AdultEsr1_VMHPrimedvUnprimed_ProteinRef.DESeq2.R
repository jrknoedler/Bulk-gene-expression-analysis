...
output <- "DESeq2Scripts/Esr1Adult_VMH_ProteinRef_PrimedvUnprimed_FULL"
...
samples <- read.table("Kallistosheets_cp/AdultEsr1Kallisto_VMH_PrimedvUnprimed.tsv", header=TRUE)
samples
