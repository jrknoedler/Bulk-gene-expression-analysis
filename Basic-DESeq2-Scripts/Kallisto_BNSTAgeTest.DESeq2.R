#!/usr/bin/env Rscript
# variables
cond1 <- "BNSTIPAduleMale"
cond2 <- "BNSTIPP15Male"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_BNSTIP_Male_AdultvP15_"
...
samples <- read.table("NewKallistoSheets/Esr1_BNST_MaleIPage_Kallisto.txt", header=TRUE)
samples
