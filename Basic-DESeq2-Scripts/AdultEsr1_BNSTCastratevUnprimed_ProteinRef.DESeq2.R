#!/usr/bin/env Rscript
# variables
cond1 <- "CastrateMaleBNST"
cond2 <- "UnprimedBNST"

output <- "DESeq2Scripts/Esr1Adult_BNSTCastratevUnprimed_local"
...
samples <- read.table("Kallistosheets_cp/AdultEsr1Kallisto_BNST_CastratevUnprimed.tsv", header=TRUE)
samples
