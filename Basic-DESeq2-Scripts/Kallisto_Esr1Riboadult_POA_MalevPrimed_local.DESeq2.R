...
cond1 <- "MalePOA"
cond2 <- "POAPrimed"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_Esr1Adult_POA_MalevPrimed_deopt_local_"
...
samples <- read.table("NewKallistoSheets/AdultEsr1Kallisto_POA_MalevPrimed.tsv", header=TRUE)
samples
