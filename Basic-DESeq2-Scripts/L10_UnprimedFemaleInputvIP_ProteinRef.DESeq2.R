...
output <- "DESeq2Scripts/L10_FemaleUnprimed_IPvInputall_Proteinref_"
...
samples <- read.table("Kallistosheets_cp/L10_Unprimed_Female_IPvInput_no_outliers.txt", header=TRUE)
samples
