...
output <- "DESeq2Scripts/L10_Redo_batch_PrimedvUnprimed"
...
samples <- read.table("Kallistosheets/L10_PrimedvUnprimed.txt", header=TRUE)
samples
...
ychromgenes <- read.table("/home/groups/nirao/Bioinformatics3/Bioinformatics/Ychrom_proteincoding_unique_ensemble.txt")
