...
# variables
cond1 <- "MaleIntactPOA"
cond2 <- "MaleCastratePOA"

output <- "DESeq2Scripts/Esr1Adult_POA_MalevCastrate_no_outlier_local"
...
samples <- read.table("Kallistosheets_cp/AdultEsr1Kallisto_POA_Malevcastrate_nooutlier.tsv", header=TRUE)
samples
