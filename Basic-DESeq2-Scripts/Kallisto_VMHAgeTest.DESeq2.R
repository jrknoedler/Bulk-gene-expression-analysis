...
cond1 <- "P15VMHInput"
cond2 <- "AdultVMHInput"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_VMHInputAgetest_"
...
samples <- read.table("NewKallistoSheets/VMHInput_Agetest.txt", header=TRUE)
samples
...
sampleTable <- data.frame(condition = factor(c(rep(cond1, 4), rep(cond2, 8))))
