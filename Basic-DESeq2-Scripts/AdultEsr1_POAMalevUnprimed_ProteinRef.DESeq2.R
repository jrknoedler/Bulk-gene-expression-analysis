...
output <- "DESeq2Scripts/Esr1Adult_POA_ProteinRef_MalevUnprimed_local"
...
samples <- read.table("Kallistosheets_cp/AdultEsr1Kallisto_POA_MalevPrimed.tsv", header=TRUE)
samples
