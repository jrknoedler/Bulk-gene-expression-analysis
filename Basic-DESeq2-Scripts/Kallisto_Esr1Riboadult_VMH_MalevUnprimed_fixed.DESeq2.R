...
cond1 <- "MaleVMH"
cond2 <- "VMHUnprimed"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_Esr1Adult_VMH_MalevUnprimed_deopt_fixed"
...
samples <- read.table("NewKallistoSheets/AdultEsr1Kallisto_VMH_UnprimedvMale_fixed.tsv", header=TRUE)
samples
