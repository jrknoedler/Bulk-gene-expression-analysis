...
cond7 <- "FemaleVMH"
cond8 <- "MaleVMH"
output <- "DESeq2Scripts/P15_GlobalBatchCorrection2_MaleVMHupdate_dropvariable"
...
sampleTable <- data.frame(condition=factor(c(rep(cond1, 2), rep(cond2, 2), rep(cond3, 2), rep(cond4, 2), rep(cond5, 2), rep(cond6, 2), rep(cond7, 2), rep(cond8, 2))), batch = c(rep("1"), rep("2"), rep("1"), rep("2"),rep("1"), rep("2"),rep("1"), rep("2"),rep("1"), rep("2"),rep("1"), rep("2"),rep("1"), rep("2"),rep("1"), rep("2")))
