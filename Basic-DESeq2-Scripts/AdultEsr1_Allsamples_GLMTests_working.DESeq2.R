...
output <- "DESeq2Scripts/Esr1Adult_AllSamples_GLMtests_region"
...
resMalevPrimed <- results(dds, contrast=c("condition", cond12,cond15))
...
## Write results
write.csv(resMalevPrimeddata, file=paste0(output, "_POAprimedvpreg-ExpDiff.csv"))
