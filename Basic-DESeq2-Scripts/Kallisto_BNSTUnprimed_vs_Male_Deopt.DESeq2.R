...
cond2 <- "BNSTPrimed"
rep2 <- 2
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_BNSTUnprimedVMale_local_Deopt_"
...
dir <- "/scratch/users/knoedler/All_Kallisto_vM17/"
samples <- read.table("AdultKallistoDataSheets/AdultKallistoBNST_DeoptTest_MalevUnprimed.tsv", header=TRUE)
samples
