...
cond1 <- "BNSTUnprimed"
cond2 <- "MaleBNST"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_Esr1Adult_BNST_UnprimedvMale_deopt"
...
samples <- read.table("NewKallistoSheets/AdultEsr1Kallisto_BNST_UprimedvMale_3v2.tsv", header=TRUE)
samples
