...
output <- "DESeq2Scripts/Esr1_TRAP_VMHMalevUnprimed_ProteinRef_droplow"
...
samples <- read.table("NewKallistoSheets/AdultEsr1Kallisto_VMH_malevunprimed.tsv", header=TRUE)
samples
...
plotPCA(rld, intgroup="condition",ntop=300)
