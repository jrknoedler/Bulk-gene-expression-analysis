...
output <- "All_RNASeq_Analyses/DESeq2/BNSTDeoptTest_"
...
samples <- read.table("AdultKallistoDataSheets/AdultKallistoBNST_DeoptTest.tsv", header=TRUE)
samples
...
sampleTable <- data.frame(condition = factor(c(rep(cond1, 2), rep(cond2, 2), rep(cond3, 2))))
