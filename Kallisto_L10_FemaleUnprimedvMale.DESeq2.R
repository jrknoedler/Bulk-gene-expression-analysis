...
cond1 <- "UnprimedIP"
cond2 <- "MaleIP"
output <- "AdultRiboEsr1NoDedupOut2/DESeq2/Kallisto_L10_PrimedvMale"
...
dir <- "/scratch/users/knoedler/L10_Kallisto_vM17/"
samples <- read.table("AdultKallistoDataSheets/L10VMH_PrimedvMale.txt", header=TRUE)
samples
...
sampleTable <- data.frame(condition = factor(c(rep(cond1, 5), rep(cond2, 3))))
