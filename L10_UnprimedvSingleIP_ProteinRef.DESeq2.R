#!/usr/bin/env Rscript
# variables
cond1 <- "Unprimed Female"
cond2 <- "Single House Male"

output <- "DESeq2Scripts/L10_FemaleUnprimedvSinglehousedmale"
...
samples <- read.table("Kallistosheets_cp/L10VMH_IP_UnprimedvSingle.txt", header=TRUE)
samples
