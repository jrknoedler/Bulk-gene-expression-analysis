...
cond1 <- "BNSTPrimed"
cond2 <- "BNSTUnprimed"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_Esr1Adult_BNST_PrimedvMale_FULL"
...
samples <- read.table("NewKallistoSheets/AdultEsr1Kallisto_BNST_FemalePrimedvMale_FULL.tsv", header=TRUE)
samples
...
sampleTable <- data.frame(condition = factor(c(rep(cond1, 3), rep(cond2, 4))))
