...
cond1 <- "VMHPrimed"
cond2 <- "VMHUnprimed"
output <- "All_RNASeq_Analyses/DESeq2/Kallisto_Esr1Adult_VMH_PrimedvUnprimed_deopt_batch"
...
samples <- read.table("NewKallistoSheets/AdultEsr1Kallisto_VMH_PrimedvUnprimed.tsv", header=TRUE)
samples
