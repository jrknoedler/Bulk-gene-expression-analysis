...
Row1 <- (BNST |blank| MeA|blank | POA|blank |VMH)  + plot_layout(widths=c(1,0.01,1,0.01,1,0.01,1))
Row2 <- (BNST |blank| MeA|blank | POA|blank |VMH)  + plot_layout(widths=c(1,0.01,1,0.01,1,0.01,1))
